        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarResponsive">
          <ul class="navbar-nav">
            ...
            {{-- <li class="nav-item nav-item-hover my-auto ">
                <a class="nav-link link-interno" href="#inicio">Ir para o Site</a>
            </li> --}}

            <li class="nav-item nav-item-hover my-auto ">
              <a class="nav-link" href="#nossa-empresa">Analisar Compras</a>
            </li>
            ...
            {{-- <li class="nav-item nav-item-hover my-auto ">
              <a class="nav-link link-interno" href="#fale-conosco"> Conosco</a>
            </li> --}}
